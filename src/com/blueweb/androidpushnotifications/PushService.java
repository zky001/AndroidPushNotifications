package com.blueweb.androidpushnotifications;
...
public class PushService extends Service
{
	...
	// MQTT协议代理网关IP.
	private static final String		MQTT_HOST = "0.0.0.0";
	// MQTT协议代理网关端口. 
	...
	// MQTT协议代理网关不应该保留发布的消息.
	private static boolean			MQTT_RETAINED_PUBLISH     = false;
		
	// MQTT客户端ID，需要发送到MQTT协议代理网关. 
	// 可以使用一个MQTT协议代理网关去向多个应用推送数据，通过MQTT_CLIENT_ID分发. 
	public static String			MQTT_CLIENT_ID = "zky001";
	...
	// Connectivity manager 检测手机是否仍旧连接
	private ConnectivityManager		mConnMan;
	// Notification manager 显示已经到达的消息通知 
	private NotificationManager		mNotifMan;

	// 服务是否已经启动.	
	private boolean 				mStarted;

	// AlarmManager使用，KEEP_ALIVE_INTERVAL
	// 可以在设备睡眠的时候依旧保持连接
	...
	// Notification 标题
	public static String			NOTIF_TITLE = "Tozky001"; 	
	// Notification ID
	...
	public void onCreate() {
		...
		// 获取preferences, connectivity manager and notification manager的实例
	...
	private void showNotification(String text) {
		...
		n.icon = com.blueweb.androidpushnotifications.R.drawable.icon;
